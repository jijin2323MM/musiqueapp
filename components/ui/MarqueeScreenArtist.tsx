...
import { View, Button, StyleSheet, Animated, Text, TouchableOpacity } from 'react-native';

const images = [
  require('../../assets/images/Card-artiste.png'), // Image 1
  require('../../assets/images/Card-artiste1.png'), // Image 2
  require('../../assets/images/Card-artiste2.png'), // Image 3
];

const artists = [
  require('../../assets/images/artist.png'), // Image 1
  require('../../assets/images/artist1.png'), // Image 2
  require('../../assets/images/artist2.png'), // Image 3
];

const backgrounds = ['#FFCDD2', '#C8E6C9', '#BBDEFB']; // Couleurs de fond

const MarqueeScreenArtist = ({ onBackgroundChange }) => {
...
export default MarqueeScreenArtist;
